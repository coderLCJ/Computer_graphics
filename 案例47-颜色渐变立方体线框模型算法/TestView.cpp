...
void CTestView::ReadVertex()//点表
{
	...
	double a=150;	
	V[0].x=-a;V[0].y=-a;V[0].z=-a;V[0].c=CRGB(0.0,0.0,0.0);//黑色
	V[1].x=+a;V[1].y=-a;V[1].z=-a;V[1].c=CRGB(1.0,0.0,0.0);//红色
	V[2].x=+a;V[2].y=+a;V[2].z=-a;V[2].c=CRGB(1.0,1.0,0.0);//黄色
	V[3].x=-a;V[3].y=+a;V[3].z=-a;V[3].c=CRGB(0.0,1.0,0.0);//绿色
	V[4].x=-a;V[4].y=-a;V[4].z=+a;V[4].c=CRGB(0.0,0.0,1.0);//蓝色
	V[5].x=+a;V[5].y=-a;V[5].z=+a;V[5].c=CRGB(1.0,0.0,1.0);//品红
	V[6].x=+a;V[6].y=+a;V[6].z=+a;V[6].c=CRGB(1.0,1.0,1.0);//白色
	V[7].x=-a;V[7].y=+a;V[7].z=+a;V[7].c=CRGB(0.0,1.0,1.0);//青色
}
