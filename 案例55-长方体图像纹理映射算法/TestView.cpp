...
void CTestView::ReadFace()//面表
{
	...
	F[0].t[0]=CT2(0,0);F[0].t[1]=CT2(437,0);F[0].t[2]=CT2(437,437);F[0].t[3]=CT2(0,437);//前面纹理坐标	
	F[1].SetNum(4);F[1].vI[0]=0;F[1].vI[1]=3;F[1].vI[2]=2;F[1].vI[3]=1;//后面顶点索引
	F[1].t[0]=CT2(437,0);F[1].t[1]=CT2(437,437);F[1].t[2]=CT2(0,437);F[1].t[3]=CT2(0,0);//后面纹理坐标	
	F[2].SetNum(4);F[2].vI[0]=0;F[2].vI[1]=4;F[2].vI[2]=7;F[2].vI[3]=3;//左面顶点索引
	F[2].t[0]=CT2(0,0);F[2].t[1]=CT2(107,0);F[2].t[2]=CT2(107,437);F[2].t[3]=CT2(0,437);//左面纹理坐标
    F[3].SetNum(4);F[3].vI[0]=1;F[3].vI[1]=2;F[3].vI[2]=6;F[3].vI[3]=5;//右面顶点索引
	F[3].t[0]=CT2(107,0);F[3].t[1]=CT2(107,437);F[3].t[2]=CT2(0,437);F[3].t[3]=CT2(0,0);//右面纹理坐标
	F[4].SetNum(4);F[4].vI[0]=2;F[4].vI[1]=3;F[4].vI[2]=7;F[4].vI[3]=6;//顶面顶点索引
	F[4].t[0]=CT2(0,0);F[4].t[1]=CT2(437,0);F[4].t[2]=CT2(437,107);F[4].t[3]=CT2(0,107);//顶面纹理坐标
	F[5].SetNum(4);F[5].vI[0]=0;F[5].vI[1]=1;F[5].vI[2]=5;F[5].vI[3]=4;//底面顶点索引
	F[5].t[0]=CT2(0,0);F[5].t[1]=CT2(437,0);F[5].t[2]=CT2(437,107);F[5].t[3]=CT2(0,107);//底面纹理坐标
}
